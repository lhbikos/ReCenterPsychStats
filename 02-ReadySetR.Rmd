...
* If you are using the PDF or ebook version of this OER you will realize that it is also possible to render to these formats. Albeit slighy more complicated, this is possible, too! More detailed instructions for this are provided in the [extRas](https://lhbikos.github.io/extRas/) mini-volume of [ReCentering Psych Stats](https://lhbikos.github.io/BikosRVT/ReCenter.html).
