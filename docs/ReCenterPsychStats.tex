...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-34-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-73-1.pdf} What do we observe?
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-79-1.pdf} \emph{z}-scores are transformations of raw scores, in standard deviation units. Using the following formula, so long as the mean and standard deviation are known, any set of continuously scaled scores can be transformed to a \emph{z}-scores equivalent:
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-86-1.pdf} We can also obtain the probability value with the \emph{pnorm()} function. We enter the score, the mean, and the standard deviation. As shown below, we can enter them in \emph{z} score formula or from the raw scores.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-90-1.pdf} There is a .7\% (that is less than 1\%) probability that physicians spend less than 5 minutes with a patient. The inverse (1 - .7) indicates that we can be 99\% confident that patients receive 5 or more minutes with the ICU physician.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-93-1.pdf} The probability of a physician spending 12 minutes \emph{or less} with a patient is 85\%; the probability of a physician spending 12 minutes or more with a patient is 15\%.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-104-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-105-1.pdf} We can further evaluate normality by obtaining the descriptive statistics with the \emph{describe()} function from the \emph{psych} package.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-132-1.pdf} The box of the boxplot covers the middle 50\% (the interquartile range). The horizontal line is the median. The whiskers represent three standard deviations above and below the mean. Any dots are outliers.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-161-1.pdf} The box of the boxplot covers the middle 50\% (the interquartile range). The horizontal line is the median. The whiskers represent three standard deviations above and below the mean. Any dots beyond the whiskers are outliers.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{psych}\SpecialCharTok{::}\FunctionTok{describe}\NormalTok{(df\_long}\SpecialCharTok{$}\NormalTok{Verbal)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# essential that the object names (e.g., A\_mean) are not changed}
\CommentTok{\# because they will be fed to the function in the faux package.}
\NormalTok{sub\_n }\OtherTok{\textless{}{-}} \DecValTok{10458}
\NormalTok{A\_mean }\OtherTok{\textless{}{-}} \FloatTok{8.37}
\NormalTok{B\_mean }\OtherTok{\textless{}{-}} \FloatTok{8.41}
\NormalTok{A\_sd }\OtherTok{\textless{}{-}} \FloatTok{3.36}
\NormalTok{B\_sd }\OtherTok{\textless{}{-}} \FloatTok{3.21}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-202-1.pdf} In boxplots the center value is the median. The box spans the \emph{interquartile range} and ranges from the 25th to the 75th percentile. The whiskers cover 1.5 times the interquartile range. When this does not capture the entire range, outliers are represented with dots.
...
\begin{figure}
\centering
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-203-1.pdf}
\caption{\label{fig:unnamed-chunk-203}Graphical illustration of ``between groups'' variation}
\end{figure}

\begin{figure}
\centering
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-204-1.pdf}
\caption{\label{fig:unnamed-chunk-204}Graphical illustration of ``within groups'' variation}
\end{figure}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-232-1.pdf} We can also use the model in a Shapiro-Wilk test. As before, we want a non-significant result.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-270-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-309-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-313-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-318-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-323-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-326-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-327-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-352-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-372-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-374-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-379-1.pdf} Unfortunately, the \emph{apaTables} package does not work with the \emph{rstatix} package, so a table would need to be crafted by hand.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-398-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-399-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-400-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-401-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-405-1.pdf} So far so good -- our distribution of \emph{residuals} (i.e., what is leftover after the model is applied) resembles a normal distribution.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-406-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-408-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-418-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-422-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-424-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-425-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-440-1.pdf} As in not surprising (because we tested a similar set of variables in the mixed design chapter), this relationship look like an interaction effect. Let's continue our exploration.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-454-1.pdf} \textbf{Results}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-455-1.pdf} As we look at this scatterplot, we are trying to determine if there is an interaction effect (rather than a covarying effect). The linearity here, looks reasonable and not terribly ``interacting'' (to help us decide whether empathy should be a covariate or a moderator). More testing can help us make this distinction.
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-468-1.pdf} \textbf{Results}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-486-1.pdf}
...
\includegraphics{ReCenterPsychStats_files/figure-latex/unnamed-chunk-490-1.pdf}
