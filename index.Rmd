...
* Formatted as an [html book](https://lhbikos.github.io/extRas/) via GitHub Pages
* As a [PDF](https://github.com/lhbikos/extRas/blob/main/docs/ReC_extRas.pdf) available in the [docs](https://github.com/lhbikos/extRas/tree/main/docs) folder at the GitHub repository
* As an [ebook](https://github.com/lhbikos/extRas/blob/main/docs/ReC_extRas.epub) available in the [docs](https://github.com/lhbikos/extRas/tree/main/docs) folder at the GitHub repository

All materials used in creating this OER are available at its [GitHub repo](https://github.com/lhbikos/extRas).
