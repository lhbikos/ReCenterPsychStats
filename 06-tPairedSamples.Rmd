...
```{r tidy=TRUE, tidy.opts=list(width.cutoff=70)}
pwr::pwr.t.test(d=(.08)/2.92,n = 33, power=NULL,sig.level=0.05,type="paired",alternative="two.sided")
```
...
```{r tidy=TRUE, tidy.opts=list(width.cutoff=70)}
pwr::pwr.t.test(d=(.08)/2.92,n = NULL, power=0.8,sig.level=0.05,type="paired",alternative="two.sided")
```
