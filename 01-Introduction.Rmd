...
4. Each time the book is updated, new ebook and PDF versions are also pushed out. You can access these in the "docs" folder at the [GitHub repository](https://github.com/lhbikos/ReCenterPsychStats).
...
*R Studio* is the desktop application I use for R.  It's a separate download. Choose the free, desktop, option that is appropriate for your operating system:   https://www.rstudio.com/products/RStudio/
...
* Lower right window: has a number of helpful tabs.
  ...
  + The *Viewer* and *Plots* tabs will be useful, later, in some advanced statistics when we can simultaneously examine output and still work on script.
* Primary window
  + R Studio runs in the background (in the *Console*). Very occasionally, I find useful troubleshooting information in the Console.
...
* Type any warnings you get into a search engine.  Odds are, you'll get some decent hints in a manner of seconds.  Especially at first, these are common errors:
  + The package isn't loaded (if you restarted R, you need to reload your packages). Using the double colon procedure to open a package (i.e., *package::function()*) can mitigate this problem.
